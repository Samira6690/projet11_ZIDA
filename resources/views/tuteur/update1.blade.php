...
<form action="/update1/traitement1" method="POST" class="form-group">
    @csrf
    <input type="text" name="id" style="display: none" value="{{ $tuteur->id }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Prenom" name="prenom" value="{{ $tuteur->prenom }}">
                </div>
                <div class="form-group">
...
<button type="submit" class="btn btn-primary">MODIFIER UN TUTEUR</button><br><br>
